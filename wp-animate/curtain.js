...
function Curtains(t) {
    ...
    null !== this._autoResize && void 0 !== this._autoResize || (this._autoResize = !0),
    this._autoRender = t.autoRender,
    null !== this._autoRender && void 0 !== this._autoRender || (this._autoRender = !0),
    this._watchScroll = t.watchScroll,
    null !== this._watchScroll && void 0 !== this._watchScroll || (this._watchScroll = !0),
    this.pixelRatio = t.pixelRatio || window.devicePixelRatio || 1,
    t.renderingScale = isNaN(t.renderingScale) ? 1 : parseFloat(t.renderingScale),
    this._renderingScale = Math.max(.25, Math.min(1, t.renderingScale)),
    this.premultipliedAlpha = t.premultipliedAlpha || !1,
    this.alpha = t.alpha,
    null !== this.alpha && void 0 !== this.alpha || (this.alpha = !0),
    this.antialias = t.antialias,
    null !== this.antialias && void 0 !== this.antialias || (this.antialias = !0),
    this.productionMode = t.production || !1,
    "string" == typeof t) && (console.warn("Since v4.0 you should use an object to pass your container and other parameters. Please refer to the docs: https://www.curtainsjs.com/documentation.html"),
    t = {
        container: t
    });
...
Curtains.prototype.setContainer = function(t) {
    if (t) {
        if ("string" == typeof t) {
            ...
            !this.container)
                return void (this.productionMode || console.warn("No container HTML element or ID provided. WebGL context couldn't be created"))
        } else
            t instanceof Element && (this.container = t);
        this._init()
    } else
        this.productionMode || console.warn("No container HTML element or ID provided. WebGL context couldn't be created")
}
,
Curtains.prototype._init = function() {
    ...
    if (this.gl = this.glCanvas.getContext("webgl2", t),
    this._isWebGL2 = !!this.gl,
    this.gl || (this.gl = this.glCanvas.getContext("webgl", t) || this.glCanvas.getContext("experimental-webgl", t)),
    !this.gl)
        return this.productionMode || console.warn("WebGL context could not be created"),
    ...
    this.glCanvas.addEventListener("webglcontextlost", this._contextLostHandler, !1),
    this._contextRestoredHandler = this._contextRestored.bind(this),
    this.glCanvas.addEventListener("webglcontextrestored", this._contextRestoredHandler, !1),
    this._scrollManager = {
...
Curtains.prototype._getExtensions = function() {
    this._extensions = [],
    this._isWebGL2 ? (this._extensions.EXT_color_buffer_float = this.gl.getExtension("EXT_color_buffer_float"),
    this._extensions.OES_texture_float_linear = this.gl.getExtension("OES_texture_float_linear"),
    this._extensions.WEBGL_lose_context = this.gl.getExtension("WEBGL_lose_context")) : (this._extensions.OES_vertex_array_object = this.gl.getExtension("OES_vertex_array_object"),
...
Curtains.prototype._scroll = function() {
    ...
    if (this.updateScrollValues(t.x, t.y),
...
Curtains.prototype.dispose = function() {
    ...
    var i = this
      , s = setInterval(function() {
        0 === i.planes.length && 0 === i.shaderPasses.length && 0 === i.renderTargets.length && (clearInterval(s),
        i._clear(),
        i._animationFrameID && window.cancelAnimationFrame(i._animationFrameID),
        i._resizeHandler && window.removeEventListener("resize", i._resizeHandler, !1),
        i._watchScroll && window.removeEventListener("scroll", i._scrollManager.handler, {
            passive: !0
        }),
        i.glCanvas.removeEventListener("webgllost", i._contextLostHandler, !1),
        i.glCanvas.removeEventListener("webglrestored", i._contextRestoredHandler, !1),
        i.gl && i._extensions.WEBGL_lose_context && i._extensions.WEBGL_lose_context.loseContext(),
...
Curtains.prototype._createShader = function(t, e) {
    ...
    if (this.gl.shaderSource(i, t),
    this.gl.compileShader(i),
    !this.productionMode && !this.gl.getShaderParameter(i, this.gl.COMPILE_STATUS)) {
...
Curtains.prototype._isEqualShader = function(t, e) {
    var i = !1;
    return 0 === t.localeCompare(e) && (i = !0),
    i
}
,
...
Curtains.prototype._useNewShaders = function(t, e) {
    ...
    return s && r || (this.productionMode || console.warn("Unable to find or compile the vertex or fragment shader"),
    i = !1),
    i ? {
        vs: {
            vertexShader: s,
...
Curtains.prototype._createProgram = function(t, e) {
    var i = this.gl
      , s = !0
      , r = i.createProgram();
    if (s && (i.attachShader(r, t.vs.vertexShader),
    i.attachShader(r, t.fs.fragmentShader),
    i.linkProgram(r),
    this.productionMode || i.getProgramParameter(r, i.LINK_STATUS) || (console.warn("Unable to initialize the shader program."),
    s = !1),
    ...
    s) {
        ...
        return "Plane" === e && (this._drawStacks.opaque.programs["program-" + a.id] = [],
...
Curtains.prototype._useProgram = function(t) {
    null !== this._glState.currentProgramID && this._glState.currentProgramID === t.id || (this.gl.useProgram(t.program),
...
Curtains.prototype.addPlane = function(t, e) {
    if (this.gl) {
        if (!t || 0 === t.length)
            return this.productionMode || console.warn("The html element you specified does not currently exists in the DOM"),
            this._onErrorCallback && this._onErrorCallback(),
            !1;
        var i = new Curtains.Plane(this,t,e);
        return i._usedProgram ? this.planes.push(i) : i = !1,
        i
    }
    return this.productionMode || console.warn("Unable to create a plane. The WebGl context couldn't be created"),
    this._onErrorCallback && this._onErrorCallback(),
    null
}
,
Curtains.prototype.removePlane = function(t) {
    ...
    for (s = 0; s < this._glState.programs.length; s++)
        this._drawStacks.opaque.programs["program-" + this._glState.programs[s].id] = [],
        this._drawStacks.transparent.programs["program-" + this._glState.programs[s].id] = [];
    ...
    for (s = 0; s < this.planes.length; s++) {
        ...
        "transparent" === r ? this._drawStacks[r].programs["program-" + t._usedProgram.id].unshift(t.index) : this._drawStacks[r].programs["program-" + t._usedProgram.id].push(t.index),
...
Curtains.prototype._stackPlane = function(t) {
    ...
    "transparent" === e ? (i.programs["program-" + t._usedProgram.id].unshift(t.index),
    i.order.includes(t._usedProgram.id) || i.order.unshift(t._usedProgram.id)) : (i.programs["program-" + t._usedProgram.id].push(t.index),
    i.order.includes(t._usedProgram.id) || i.order.push(t._usedProgram.id)),
    i.length++
}
,
Curtains.prototype.addRenderTarget = function(t) {
    return this.gl ? new Curtains.RenderTarget(this,t) : (this.productionMode || console.warn("Unable to create a render target. The WebGl context couldn't be created"),
    this._onErrorCallback && this._onErrorCallback(),
    null)
}
,
...
Curtains.prototype.addShaderPass = function(t) {
    if (this.gl) {
        ...
        return e._usedProgram ? (t.renderTarget ? this._drawStacks.renderPasses.push(e.index) : this._drawStacks.scenePasses.push(e.index),
        this.shaderPasses.push(e)) : e = !1,
        e
    }
    return this.productionMode || console.warn("Unable to create a shader pass. The WebGl context couldn't be created"),
    this._onErrorCallback && this._onErrorCallback(),
    null
}
,
Curtains.prototype.removeShaderPass = function(t) {
    var e;
    t._canDraw = !1,
    t.target && (t.target._shaderPass = null,
    ...
    for (i = 0; i < this.shaderPasses.length; i++)
        ...
        this.shaderPasses[i]._isScenePass ? this._drawStacks.scenePasses.push(this.shaderPasses[i].index) : this._drawStacks.renderPasses.push(this.shaderPasses[i].index);
    0 === this._drawStacks.scenePasses.length && (this._glState.scenePassIndex = null),
    t && t._dispose(),
    t = null,
    this.gl && this._clear(),
    this._glState.currentBuffersID = 0
...
Curtains.prototype._bindFrameBuffer = function(t, e) {
    ...
    t._shouldClear && !e && this._clear()) : null !== this._glState.frameBufferID && (this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, null),
    this.gl.viewport(0, 0, this.gl.drawingBufferWidth, this.gl.drawingBufferHeight)),
    this._glState.frameBufferID = i
}
,
Curtains.prototype._setDepth = function(t) {
    t && !this._glState.depthTest ? (this._glState.depthTest = t,
    this.gl.enable(this.gl.DEPTH_TEST)) : !t && this._glState.depthTest && (this._glState.depthTest = t,
...
Curtains.prototype._setBlendFunc = function() {
    var t = this.gl;
    t.enable(t.BLEND),
    this.premultipliedAlpha ? t.blendFuncSeparate(t.ONE, t.ONE_MINUS_SRC_ALPHA, t.ONE, t.ONE_MINUS_SRC_ALPHA) : t.blendFuncSeparate(t.SRC_ALPHA, t.ONE_MINUS_SRC_ALPHA, t.ONE, t.ONE_MINUS_SRC_ALPHA)
}
,
...
Curtains.prototype.render = function() {
    if (this._drawingEnabled || this._forceRender) {
        ...
        this._clear(),
        this._drawStacks.scenePasses.length > 0 && 0 === this._drawStacks.renderPasses.length && (this._glState.scenePassIndex = 0,
        this._bindFrameBuffer(this.shaderPasses[this._drawStacks.scenePasses[0]].target)),
        this._drawPlaneStack("opaque"),
        this._drawStacks.transparent.length && (this.gl.clearDepth(1),
        this.gl.clear(this.gl.DEPTH_BUFFER_BIT),
        this._drawPlaneStack("transparent")),
        this._drawStacks.scenePasses.length > 0 && this._drawStacks.renderPasses.length > 0 && (this._glState.scenePassIndex = 0,
        this._bindFrameBuffer(this.shaderPasses[this._drawStacks.scenePasses[0]].target));
...
Curtains.prototype.onAfterResize = function(t) {
    return t && (this._onAfterResizeCallback = t),
    this
}
,
Curtains.prototype.onError = function(t) {
    return t && (this._onErrorCallback = t),
    this
}
,
Curtains.prototype.onContextLost = function(t) {
    return t && (this._onContextLostCallback = t),
    this
}
,
Curtains.prototype.onContextRestored = function(t) {
    return t && (this._onContextRestoredCallback = t),
    this
}
,
Curtains.prototype.onRender = function(t) {
    return t && (this._onRenderCallback = t),
    this
}
,
Curtains.prototype.onScroll = function(t) {
    return t && (this._onScrollCallback = t),
    this
}
,
...
Curtains.BasePlane.prototype._initBasePlane = function(t) {
    ...
    this._definition.buffersID = "ShaderPass" === this._type ? 1 : this._definition.width * this._definition.height + this._definition.width,
    this._depthTest = t.depthTest,
    null !== this._depthTest && void 0 !== this._depthTest || (this._depthTest = !0),
    ...
    return this._usedProgram = this._curtains._setupProgram(s.vertexShaderCode, s.fragmentShaderCode, this),
    ...
    this.userData = {},
    !!this._usedProgram && (this._shouldDraw = !0,
    this.visible = !0,
    this._setAttributes(),
...
Curtains.BasePlane.prototype._getDefaultVS = function() {
    return this._curtains.productionMode || console.warn("No vertex shader provided, will use a default one"),
...
Curtains.BasePlane.prototype._setupShaders = function(t) {
    var e, i, s = t.vertexShaderID || this.htmlElement.getAttribute("data-vs-id"), r = t.fragmentShaderID || this.htmlElement.getAttribute("data-fs-id");
    return t.vertexShader || (e = s && document.getElementById(s) ? document.getElementById(s).innerHTML : this._getDefaultVS()),
    t.fragmentShader || (r && document.getElementById(r) ? i = document.getElementById(r).innerHTML : (this._curtains.productionMode || console.warn("No fragment shader provided, will use a default one"),
...
Curtains.BasePlane.prototype._setUniforms = function() {
    ...
    if (this.uniforms)
        for (var a in this.uniforms) {
            ...
            n.type || (Array.isArray(n.value) ? 4 === n.value.length ? (n.type = "4f",
            t.productionMode || console.warn("No uniform type declared for " + n.name + ", applied a 4f (array of 4 floats) uniform type")) : 3 === n.value.length ? (n.type = "3f",
            t.productionMode || console.warn("No uniform type declared for " + n.name + ", applied a 3f (array of 3 floats) uniform type")) : 2 === n.value.length && (n.type = "2f",
            t.productionMode || console.warn("No uniform type declared for " + n.name + ", applied a 2f (array of 2 floats) uniform type")) : n.value.constructor === Float32Array ? 16 === n.value.length ? (n.type = "mat4",
            t.productionMode || console.warn("No uniform type declared for " + n.name + ", applied a mat4 (4x4 matrix array) uniform type")) : 9 === n.value.length ? (n.type = "mat3",
            t.productionMode || console.warn("No uniform type declared for " + n.name + ", applied a mat3 (3x3 matrix array) uniform type")) : 4 === n.value.length && (n.type = "mat2",
            t.productionMode || console.warn("No uniform type declared for " + n.name + ", applied a mat2 (2x2 matrix array) uniform type")) : (n.type = "1f",
            t.productionMode || console.warn("No uniform type declared for " + n.name + ", applied a 1f (float) uniform type"))),
...
Curtains.BasePlane.prototype._updateUniforms = function() {
    if (this.uniforms)
        for (var t in this.uniforms) {
            ...
            this.shareProgram ? this._handleUniformSetting(e.type, e.location, e.value) : (e.value.length || e.value === e.lastValue ? JSON.stringify(e.value) !== JSON.stringify(e.lastValue) && this._handleUniformSetting(e.type, e.location, e.value) : this._handleUniformSetting(e.type, e.location, e.value),
            e.lastValue = e.value.length ? Array.from(e.value) : e.value)
        }
}
,
...
Curtains.BasePlane.prototype._setPlaneVertices = function() {
    ...
    for (var t = 0; t < this._definition.height; ++t)
        for (var e = t / this._definition.height, i = 0; i < this._definition.width; ++i) {
            ...
            this._geometry.vertices.push(2 * (s - .5)),
            this._geometry.vertices.push(2 * (e - .5)),
            this._geometry.vertices.push(0),
            this._material.uvs.push(s + 1 / this._definition.width),
            this._material.uvs.push(e),
            this._material.uvs.push(0),
            this._geometry.vertices.push(2 * (s + 1 / this._definition.width - .5)),
            this._geometry.vertices.push(2 * (e - .5)),
            this._geometry.vertices.push(0),
            this._material.uvs.push(s),
            ...
            this._material.uvs.push(0),
            this._geometry.vertices.push(2 * (s - .5)),
            this._geometry.vertices.push(2 * (e + 1 / this._definition.height - .5)),
            this._geometry.vertices.push(0),
            this._material.uvs.push(s),
            this._material.uvs.push(e + 1 / this._definition.height),
            this._material.uvs.push(0),
...
Curtains.BasePlane.prototype._initializeBuffers = function() {
    ...
    this._attributes && (this._geometry.bufferInfos = {
        id: t.createBuffer(),
        itemSize: 3,
    ...
    this._curtains._isWebGL2 ? (this._vao = t.createVertexArray(),
    t.bindVertexArray(this._vao)) : this._curtains._extensions.OES_vertex_array_object && (this._vao = this._curtains._extensions.OES_vertex_array_object.createVertexArrayOES(),
    ...
    t.bufferData(t.ARRAY_BUFFER, new Float32Array(this._geometry.vertices), t.STATIC_DRAW),
    t.vertexAttribPointer(this._attributes.vertexPosition.location, this._geometry.bufferInfos.itemSize, t.FLOAT, !1, 0, 0),
    ...
    t.bufferData(t.ARRAY_BUFFER, new Float32Array(this._material.uvs), t.STATIC_DRAW),
    t.vertexAttribPointer(this._attributes.textureCoord.location, this._material.bufferInfos.itemSize, t.FLOAT, !1, 0, 0),
...
Curtains.BasePlane.prototype._restoreContext = function() {
    ...
    this._usedProgram = t._setupProgram(this._usedProgram.vsCode, this._usedProgram.fsCode, this),
    this._usedProgram) {
        ...
        for (var i = "ShaderPass" === this._type ? 1 : 0; i < this.textures.length; i++)
            this.textures[i]._restoreContext();
        "Plane" === this._type && (this._initMatrices(),
...
Curtains.BasePlane.prototype._getNearPlaneIntersections = function(t, e, i) {
    ...
    if (1 === i.length)
        0 === i[0] ? (e[0] = s(e[1], this._curtains._applyMatrixToPoint([.95, 1, 0], this._matrices.mVPMatrix)),
        e.push(s(e[3], this._curtains._applyMatrixToPoint([-1, -.95, 0], this._matrices.mVPMatrix)))) : 1 === i[0] ? (e[1] = s(e[0], this._curtains._applyMatrixToPoint([-.95, 1, 0], this._matrices.mVPMatrix)),
        e.push(s(e[2], this._curtains._applyMatrixToPoint([1, -.95, 0], this._matrices.mVPMatrix)))) : 2 === i[0] ? (e[2] = s(e[3], this._curtains._applyMatrixToPoint([-.95, -1, 0], this._matrices.mVPMatrix)),
        e.push(s(e[1], this._curtains._applyMatrixToPoint([1, .95, 0], this._matrices.mVPMatrix)))) : 3 === i[0] && (e[3] = s(e[2], this._curtains._applyMatrixToPoint([.95, -1, 0], this._matrices.mVPMatrix)),
        e.push(s(e[0], this._curtains._applyMatrixToPoint([-1, .95, 0], this._matrices.mVPMatrix))));
    else if (2 === i.length)
        0 === i[0] && 1 === i[1] ? (e[0] = s(e[3], this._curtains._applyMatrixToPoint([-1, -.95, 0], this._matrices.mVPMatrix)),
        e[1] = s(e[2], this._curtains._applyMatrixToPoint([1, -.95, 0], this._matrices.mVPMatrix))) : 1 === i[0] && 2 === i[1] ? (e[1] = s(e[0], this._curtains._applyMatrixToPoint([-.95, 1, 0], this._matrices.mVPMatrix)),
        e[2] = s(e[3], this._curtains._applyMatrixToPoint([-.95, -1, 0], this._matrices.mVPMatrix))) : 2 === i[0] && 3 === i[1] ? (e[2] = s(e[1], this._curtains._applyMatrixToPoint([1, .95, 0], this._matrices.mVPMatrix)),
        e[3] = s(e[0], this._curtains._applyMatrixToPoint([-1, .95, 0], this._matrices.mVPMatrix))) : 0 === i[0] && 3 === i[1] && (e[0] = s(e[1], this._curtains._applyMatrixToPoint([.95, 1, 0], this._matrices.mVPMatrix)),
        e[3] = s(e[2], this._curtains._applyMatrixToPoint([.95, -1, 0], this._matrices.mVPMatrix)));
    else if (3 === i.length) {
        for (var r = 0, a = 0; a < t.length; a++)
            i.includes(a) || (r = a);
        e = [e[r]],
        0 === r ? (e.push(s(e[0], this._curtains._applyMatrixToPoint([-.95, 1, 0], this._matrices.mVPMatrix))),
        e.push(s(e[0], this._curtains._applyMatrixToPoint([-1, .95, 0], this._matrices.mVPMatrix)))) : 1 === r ? (e.push(s(e[0], this._curtains._applyMatrixToPoint([.95, 1, 0], this._matrices.mVPMatrix))),
        e.push(s(e[0], this._curtains._applyMatrixToPoint([1, .95, 0], this._matrices.mVPMatrix)))) : 2 === r ? (e.push(s(e[0], this._curtains._applyMatrixToPoint([.95, -1, 0], this._matrices.mVPMatrix))),
        e.push(s(e[0], this._curtains._applyMatrixToPoint([1, -.95, 0], this._matrices.mVPMatrix)))) : 3 === r && (e.push(s(e[0], this._curtains._applyMatrixToPoint([-.95, -1, 0], this._matrices.mVPMatrix))),
        e.push(s(e[0], this._curtains._applyMatrixToPoint([-1, -.95, 0], this._matrices.mVPMatrix))))
    } else
...
Curtains.BasePlane.prototype.planeResize = function() {
    this._setDocumentSizes(),
    "Plane" === this._type && (this.setPerspective(this._fov, this._nearPlane, this._farPlane),
    this._applyWorldPositions());
...
Curtains.BasePlane.prototype.createTexture = function(t) {
    ...
    this._curtains.productionMode || console.warn("Since v5.1 you should use an object to pass your sampler name with the createTexture() method. Please refer to the docs: https://www.curtainsjs.com/documentation.html (texture concerned: ", t.sampler, ")")),
    t || (t = {});
...
Curtains.BasePlane.prototype._isPlaneReady = function() {
    if (!this._loadingManager.complete && this._loadingManager.sourcesLoaded >= this._loadingManager.initSourcesToLoad) {
        this._loadingManager.complete = !0,
...
Curtains.BasePlane.prototype.loadImage = function(t) {
    ...
    if (s._onSourceLoadedHandler = s._onSourceLoaded.bind(s, e),
    e.complete)
        s._onSourceLoaded(e);
    else if (e.decode) {
        var r = this;
...
Curtains.BasePlane.prototype._bindPlaneBuffers = function() {
    var t = this._curtains
      , e = t.gl;
    this._vao ? t._isWebGL2 ? t.gl.bindVertexArray(this._vao) : t._extensions.OES_vertex_array_object.bindVertexArrayOES(this._vao) : (e.enableVertexAttribArray(this._attributes.vertexPosition.location),
    e.bindBuffer(e.ARRAY_BUFFER, this._geometry.bufferInfos.id),
    e.vertexAttribPointer(this._attributes.vertexPosition.location, this._geometry.bufferInfos.itemSize, e.FLOAT, !1, 0, 0),
    ...
    e.vertexAttribPointer(this._attributes.textureCoord.location, this._material.bufferInfos.itemSize, e.FLOAT, !1, 0, 0)),
...
Curtains.BasePlane.prototype._bindPlaneTexture = function(t) {
    ...
    t._canDraw && (e.activeTexture(e.TEXTURE0 + t.index),
...
Curtains.BasePlane.prototype._drawPlane = function() {
    var t = this._curtains
      , e = t.gl;
    if (this._canDraw && (this._onRenderCallback && this._onRenderCallback(),
    "ShaderPass" === this._type ? this._isScenePass ? t._glState.scenePassIndex + 1 < t._drawStacks.scenePasses.length ? (t._bindFrameBuffer(t.shaderPasses[t._drawStacks.scenePasses[t._glState.scenePassIndex + 1]].target),
    t._glState.scenePassIndex++) : t._bindFrameBuffer(null) : null === t._glState.scenePassIndex && t._bindFrameBuffer(null) : (this.target ? t._bindFrameBuffer(this.target) : null === t._glState.scenePassIndex && t._bindFrameBuffer(null),
    ...
    (this.alwaysDraw || this._shouldDraw) && this.visible)) {
        ...
        t._glState.currentBuffersID !== this._definition.buffersID && this._bindPlaneBuffers();
...
Curtains.BasePlane.prototype._dispose = function() {
    var t = this._curtains.gl;
    if (t) {
        this._vao && (this._curtains._isWebGL2 ? t.deleteVertexArray(this._vao) : this._curtains._extensions.OES_vertex_array_object.deleteVertexArrayOES(this._vao)),
        this._geometry && (t.bindBuffer(t.ARRAY_BUFFER, this._geometry.bufferInfos.id),
        t.bufferData(t.ARRAY_BUFFER, 1, t.STATIC_DRAW),
        t.deleteBuffer(this._geometry.bufferInfos.id),
        this._geometry = null),
        this._material && (t.bindBuffer(t.ARRAY_BUFFER, this._material.bufferInfos.id),
        t.bufferData(t.ARRAY_BUFFER, 1, t.STATIC_DRAW),
        t.deleteBuffer(this._material.bufferInfos.id),
        this._material = null),
        this.target && "ShaderPass" === this._type && (this._curtains.removeRenderTarget(this.target),
        this.textures.shift());
...
Curtains.BasePlane.prototype.onLoading = function(t) {
    return t && (this._onPlaneLoadingCallback = t),
    this
}
,
Curtains.BasePlane.prototype.onReady = function(t) {
    return t && (this._onReadyCallback = t),
    this
}
,
...
Curtains.BasePlane.prototype.onAfterRender = function(t) {
    return t && (this._onAfterRenderCallback = t),
    this
}
,
Curtains.Plane = function(t, e, i) {
    ...
    this._usedProgram ? (this._curtains._stackPlane(this),
    this._initPositions(),
    this._initSources()) : this._curtains._onErrorCallback && this._curtains._onErrorCallback()
}
,
...
Curtains.Plane.prototype._setInitParams = function(t) {
    ...
    null !== this.autoloadSources && void 0 !== this.autoloadSources || (this.autoloadSources = !0),
    this._fov = t.fov || 50,
    this._nearPlane = .1,
    this._farPlane = 150,
    null === t.watchScroll || void 0 === t.watchScroll ? this.watchScroll = this._curtains._watchScroll : this.watchScroll = t.watchScroll || !1,
...
Curtains.Plane.prototype._initSources = function() {
    if (this.autoloadSources) {
        ...
        var i = [];
        for (e = 0; e < this.htmlElement.getElementsByTagName("video").length; e++)
            i.push(this.htmlElement.getElementsByTagName("video")[e]);
        i.length > 0 && this.loadSources(i);
        var s = [];
        for (e = 0; e < this.htmlElement.getElementsByTagName("canvas").length; e++)
            s.push(this.htmlElement.getElementsByTagName("canvas")[e]);
        s.length > 0 && this.loadSources(s),
        this._loadingManager.initSourcesToLoad = t.length + i.length + s.length
    }
    0 === this._loadingManager.initSourcesToLoad && (this._isPlaneReady(),
    this._curtains.productionMode || console.warn("This plane does not contain any image, video or canvas element. You may want to add some later with the loadSource() or loadSources() method.")),
    this._canDraw = !0,
    this._curtains.needRender(),
...
Curtains.Plane.prototype.resetPlane = function(t) {
    ...
    this.updatePosition()) : t || this._curtains.productionMode || console.warn("You are trying to reset a plane with a HTML element that does not exist. The old HTML element will be kept instead.")
}
,
...
Curtains.Plane.prototype._setPerspectiveMatrix = function() {
    ...
    (this.shareProgram || !this.shareProgram && this._updatePerspectiveMatrix) && (this._curtains._useProgram(this._usedProgram),
    this._curtains.gl.uniformMatrix4fv(this._matrices.pMatrix.location, !1, this._matrices.pMatrix.matrix)),
    this._updatePerspectiveMatrix = !1
}
,
Curtains.Plane.prototype.setPerspective = function(t, e, i) {
    ...
    this._cameraZPosition = 2 * Math.tan(Math.PI / 180 * .5 * this._fov),
    this._CSSPerspective = Math.pow(Math.pow(this._curtains._boundingRect.width / (2 * this._curtains.pixelRatio), 2) + Math.pow(this._curtains._boundingRect.height / (2 * this._curtains.pixelRatio), 2), .5) / Math.tan(this._fov / 2 * Math.PI / 180),
    this._nearPlane = isNaN(e) ? this._nearPlane : parseFloat(e),
    this._nearPlane = Math.max(this._nearPlane, .01),
...
Curtains.Plane.prototype._setMVMatrix = function() {
    ...
    (this.shareProgram || !this.shareProgram && this._updateMVMatrix) && (this._curtains._useProgram(this._usedProgram),
    this._curtains.gl.uniformMatrix4fv(this._matrices.mvMatrix.location, !1, this._matrices.mvMatrix.matrix)),
    this._updateMVMatrix = !1
}
,
Curtains.Plane.prototype.setScale = function(t, e) {
    if (t = isNaN(t) ? this.scale.x : parseFloat(t),
...
Curtains.Plane.prototype.setRotation = function(t, e, i) {
    ...
    t === this.rotation.x && e === this.rotation.y && i === this.rotation.z || (this.rotation = {
        x: t,
        y: e,
        z: i
    },
...
Curtains.Plane.prototype.setTransformOrigin = function(t, e, i) {
    ...
    t === this.transformOrigin.x && e === this.transformOrigin.y && i === this.transformOrigin.z || (this.transformOrigin = {
        x: t,
        y: e,
        z: i
    },
...
Curtains.Plane.prototype._setTranslation = function() {
    ...
    0 === this.relativeTranslation.x && 0 === this.relativeTranslation.y && 0 === this.relativeTranslation.z || (t = this._documentToLocalSpace(this.relativeTranslation.x, this.relativeTranslation.y)),
...
Curtains.Plane.prototype.setRelativePosition = function(t, e, i) {
    ...
    t === this.relativeTranslation.x && e === this.relativeTranslation.y && i === this.relativeTranslation.z || (this.relativeTranslation = {
        x: t,
        y: e,
        z: i
    },
...
Curtains.Plane.prototype.updateScrollPosition = function() {
    (this._curtains._scrollManager.lastXDelta || this._curtains._scrollManager.lastYDelta) && (this._boundingRect.document.top += this._curtains._scrollManager.lastYDelta * this._curtains.pixelRatio,
...
Curtains.Plane.prototype.moveToFront = function() {
    ...
    for (var t = this._transparent ? "transparent" : "opaque", e = this._curtains._drawStacks[t].programs["program-" + this._usedProgram.id], i = 0; i < e.length; i++)
        this.index === e[i] && e.splice(i, 1);
    "transparent" === t ? e.unshift(this.index) : e.push(this.index),
    this._curtains._drawStacks[t].programs["program-" + this._usedProgram.id] = e;
...
Curtains.RenderTarget = function(t, e) {
    ...
    null !== this._shouldClear && void 0 !== this._shouldClear || (this._shouldClear = !0),
    this._minSize = {
...
Curtains.RenderTarget.prototype.resize = function() {
    this._shaderPass && this._shaderPass._isScenePass && (this._setSize(),
...
Curtains.RenderTarget.prototype._bindDepthBuffer = function() {
    var t = this._curtains.gl;
    this._depthBuffer && (t.bindRenderbuffer(t.RENDERBUFFER, this._depthBuffer),
    t.renderbufferStorage(t.RENDERBUFFER, t.DEPTH_COMPONENT16, this._size.width, this._size.height),
    t.framebufferRenderbuffer(t.FRAMEBUFFER, t.DEPTH_ATTACHMENT, t.RENDERBUFFER, this._depthBuffer))
}
,
...
Curtains.RenderTarget.prototype._createFrameBuffer = function() {
    ...
    this._depth && (this._depthBuffer = t.createRenderbuffer(),
    this._bindDepthBuffer()),
    this._curtains._bindFrameBuffer(null)
}
,
Curtains.RenderTarget.prototype._restoreContext = function() {
    this._shaderPass && this._shaderPass._isScenePass || (this._shaderPass = null,
    this._createFrameBuffer())
}
,
Curtains.RenderTarget.prototype._dispose = function() {
    this._frameBuffer && (this._curtains.gl.deleteFramebuffer(this._frameBuffer),
    this._frameBuffer = null),
    this._depthBuffer && (this._curtains.gl.deleteRenderbuffer(this._depthBuffer),
...
Curtains.Texture = function(t, e) {
    ...
    t._usedProgram || e.isFBOTexture)
        return this.index = t.textures.length,
        this._sampler = {
            isActive: !1,
        ...
        this._canDraw = !1,
        e.fromTexture ? (this._initFromTexture = !0,
        this._parent._usedProgram && this._setTextureUniforms(),
        void this.setFromTexture(e.fromTexture)) : (this._initFromTexture = !1,
        this._init(),
        this);
...
Curtains.Texture.prototype._init = function() {
    var t = this._curtains.gl;
    if (this._sampler.texture = t.createTexture(),
    ...
    this._curtains._glState.flipY && (this._curtains._glState.flipY = this._flipY,
    ...
    this._parent._usedProgram) {
        ...
        "empty" === this.type)
            t.texImage2D(t.TEXTURE_2D, 0, this._internalFormat, 1, 1, 0, this._format, this._textureType, new Uint8Array([0, 0, 0, 255])),
    ...
    "fboTexture" === this.type && (this._curtains._isWebGL2 && this._curtains._extensions.EXT_color_buffer_float ? (this._internalFormat = t.RGBA16F,
    this._textureType = t.HALF_FLOAT) : this._curtains._extensions.OES_texture_half_float && (this._textureType = this._curtains._extensions.OES_texture_half_float.HALF_FLOAT_OES),
    t.texImage2D(t.TEXTURE_2D, 0, this._internalFormat, this._size.width, this._size.height, 0, this._format, this._textureType, null),
    this._setMipmaps()),
    this._canDraw = !0
}
,
Curtains.Texture.prototype._setTextureUniforms = function() {
    for (var t = 0; t < this._parent._activeTextures.length; t++)
        this._parent._activeTextures[t].name === this._sampler.name && (this._sampler.isActive = !0,
...
Curtains.Texture.prototype.setFromTexture = function(t) {
    if (t) {
        ...
        this._parent._usedProgram && (!this._canDraw || !this._textureMatrix.matrix)) {
            var e = this._getSizes();
            this._updateTextureMatrix(e),
            this._canDraw = !0
        }
    } else
        this._curtains.productionMode || console.warn("Unable to set the texture from texture:", t)
}
,
Curtains.Texture.prototype.setSource = function(t) {
    if (this._parent._usedProgram) {
        this.source = t,
        "empty" === this.type && ("IMG" === t.tagName.toUpperCase() ? this.type = "image" : "VIDEO" === t.tagName.toUpperCase() ? (this.type = "video",
        this.shouldUpdate = !0) : "CANVAS" === t.tagName.toUpperCase() ? (this.type = "canvas",
        this._willUpdate = !0,
        this.shouldUpdate = !0) : this._curtains.productionMode || console.warn("this HTML tag could not be converted into a texture:", t.tagName)),
        this._size = {
        ...
        this._curtains.premultipliedAlpha && e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !0),
        this._flipY = !0,
        this._curtains._glState.flipY || (this._curtains._glState.flipY = this._flipY,
        e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL, this._flipY)),
        this.resize(),
        "image" === this.type && (e.texImage2D(e.TEXTURE_2D, 0, this._internalFormat, this._format, this._textureType, t),
        this._setMipmaps()),
        this._curtains.needRender()
    } else
        this._curtains.productionMode || console.warn("Unable to set the texture source because the program is not valid")
}
,
Curtains.Texture.prototype._setMipmaps = function() {
    ...
    this._curtains._isWebGL2 && "image" === this.type ? (t.generateMipmap(t.TEXTURE_2D),
    t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, t.LINEAR_MIPMAP_NEAREST)) : t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, t.LINEAR),
...
Curtains.Texture.prototype._update = function() {
    var t = this._curtains.gl;
    this.source ? (t.texImage2D(t.TEXTURE_2D, 0, this._internalFormat, this._format, this._textureType, this.source),
    this._texParameters || this._setMipmaps()) : t.texImage2D(t.TEXTURE_2D, 0, this._internalFormat, this._size.width, this._size.height, 0, this._format, this._textureType, this.source)
}
,
...
Curtains.Texture.prototype.setScale = function(t, e) {
    ...
    t = Math.max(t, .001),
    e = Math.max(e, .001),
    t === this.scale.x && e === this.scale.y || (this.scale = {
        x: t,
        y: e
    },
    this.resize())
...
Curtains.Texture.prototype.resize = function() {
    if ("fboTexture" === this.type) {
        ...
        this._originalTexture || (t.bindTexture(t.TEXTURE_2D, this._parent.textures[0]._sampler.texture),
        t.texImage2D(t.TEXTURE_2D, 0, this._internalFormat, this._size.width, this._size.height, 0, this._format, this._textureType, this.source))
    } else
        this.source && (this._size = {
            width: this.source.naturalWidth || this.source.width || this.source.videoWidth,
            height: this.source.naturalHeight || this.source.height || this.source.videoHeight
        });
    if (this._parent._usedProgram) {
...
Curtains.Texture.prototype._updateTextureMatrix = function(t) {
    ...
    this._curtains._useProgram(this._parent._usedProgram),
    this._curtains.gl.uniformMatrix4fv(this._textureMatrix.location, !1, this._textureMatrix.matrix)
}
,
...
Curtains.Texture.prototype._drawTexture = function() {
    this._sampler.isActive && (this._parent._bindPlaneTexture(this),
    this._flipY && !this._curtains._glState.flipY && (this._curtains._glState.flipY = this._flipY,
    this._curtains.gl.pixelStorei(this._curtains.gl.UNPACK_FLIP_Y_WEBGL, this._flipY)),
    "video" === this.type && this.source && this.source.readyState >= this.source.HAVE_CURRENT_DATA && (this._willUpdate = !0),
    (this._forceUpdate || this._willUpdate && this.shouldUpdate) && this._update(),
    ...
    this._originalTexture) {
        ...
        if (this._originalTexture._canDraw)
            ...
            var e = setInterval(function() {
                t._originalTexture._canDraw && (t._restoreFromTexture(),
                clearInterval(e))
            }, 16)
    } else
        this._init(),
        this.source && ("image" === this.type && this._curtains._imageCache.push(this),
        this.setSource(this.source),
        this.needUpdate())
}
,
Curtains.Texture.prototype._dispose = function() {
    "video" === this.type ? (this.source.removeEventListener("canplaythrough", this._onSourceLoadedHandler, !1),
    this.source.removeEventListener("error", this._parent._sourceLoadError, !1),
    this.source.pause(),
    this.source.removeAttribute("src"),
    this.source.load(),
    this.source = null) : "canvas" === this.type ? (this.source.width = this.source.width,
    this.source = null) : "image" === this.type && this._curtains._isDestroying && (this.source.removeEventListener("load", this._onSourceLoadedHandler, !1),
    this.source.removeEventListener("error", this._parent._sourceLoadError, !1),
    this.source = null);
    var t = this._curtains.gl;
    t && !this._originalTexture && ("image" !== this.type || this._curtains._isDestroying) && (t.activeTexture(t.TEXTURE0 + this.index),
